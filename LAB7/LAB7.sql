...
INSERT INTO Employee VALUES(2, 'Rocky', 'Captain', 10000.0, NULL);
INSERT INTO Employee VALUES(3, 'Bender Bending Rodriguez', 'Robot', 7500.0, NULL);
INSERT INTO Employee VALUES(4, 'Manav', 'CEO', 20000.0, NULL);
INSERT INTO Employee VALUES(5, 'John A. Zoidberg', 'Physician', 25.0, NULL);
INSERT INTO Employee VALUES(6, 'Gerard', 'Intern', 5000.0, NULL);
...
INSERT INTO Client VALUES(9, 'Mor');
...
INSERT INTO Planet VALUES(5001, 'Decapod X', 65498463216.3466);
INSERT INTO Planet VALUES(3, 'Morag', 32435021.65468);
...
-- SELECT AVG(Salary)
-- from Employee;
-- SELECT Coordinates from Planet where PlanetID=5001;
-- SELECT Contents, Weight
-- FROM Shipment
-- INNER JOIN Package
-- ON Shipment.ShipmentID = Package.PackageNumber where Date=2022/05/12;
-- SELECT Position, Salary
-- FROM Employee
-- INNER JOIN Planet
-- ON Employee.EmployeeID = Planet.PlanetID where Planet.Name='Morag';
-- SELECT Sender, Recipient
-- FROM Shipment
-- INNER JOIN Package
-- ON Shipment.ShipmentID = Package.PackageNumber where Shipment.Manager=4 ;
-- SELECT Recipient FROM Package where Contents='Pens' and Contents='Notebooks'
-- Delete From Package where Sender=2;   
-- delete package from package inner join client on package.sender=client.accountnumber where client.name="ROCKY";
-- Select* from package ;
UPDATE Planet SET Coordinates = 65007070770 where Name='Vormir';
Select * From Planet;
